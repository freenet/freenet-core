...
async fn process_client_request(
    ...
    let req: ClientRequest = {
        match ClientRequest::from_vec(msg) {
            Ok(r) => r,
            Err(e) => {
...
fn test_handle_update_request() -> Result<(), Box<dyn std::error::Error>>{
    let expected_client_request = ClientRequest::Update {
        key: ContractKey::from_spec("JAgVrRHt88YbBFjGQtBD3uEmRUFvZQqK7k8ypnJ8g6TC".to_string()).unwrap(),
        delta: StateDelta::from(vec![91,10,32,32,32,32,123,10,32,32,32,32,32,32,32,32,34,97,117,116,104,111,114,34,58,34,73,68,71,34,44,10,32,32,32,32,32,32,32,32,34,100,97,116,101,34,58,34,50,48,50,50,45,48,54,45,49,53,84,48,48,58,48,48,58,48,48,90,34,44,10,32,32,32,32,32,32,32,32,34,116,105,116,108,101,34,58,34,78,101,119,32,109,115,103,34,44,10,32,32,32,32,32,32,32,32,34,99,111,110,116,101,110,116,34,58,34,46,46,46,34,10,32,32,32,32,125,10,93,10,32,32,32,32])
    };
    let msg: Vec<u8> = vec![130, 163, 107, 101, 121, 130, 164, 115, 112, 101, 99, 196, 32, 255, 17, 144, 159, 194, 187, 46, 33, 205, 77, 242, 70, 87, 18, 202, 62, 226, 149, 25, 151, 188, 167, 153, 197, 129, 25, 179, 198, 218, 99, 159, 139, 168, 99, 111, 110, 116, 114, 97, 99, 116, 192, 165, 100, 101, 108, 116, 97, 196, 134, 91, 10, 32, 32, 32, 32, 123, 10, 32, 32, 32, 32, 32, 32, 32, 32, 34, 97, 117, 116, 104, 111, 114, 34, 58, 34, 73, 68, 71, 34, 44, 10, 32, 32, 32, 32, 32, 32, 32, 32, 34, 100, 97, 116, 101, 34, 58, 34, 50, 48, 50, 50, 45, 48, 54, 45, 49, 53, 84, 48, 48, 58, 48, 48, 58, 48, 48, 90, 34, 44, 10, 32, 32, 32, 32, 32, 32, 32, 32, 34, 116, 105, 116, 108, 101, 34, 58, 34, 78, 101, 119, 32, 109, 115, 103, 34, 44, 10, 32, 32, 32, 32, 32, 32, 32, 32, 34, 99, 111, 110, 116, 101, 110, 116, 34, 58, 34, 46, 46, 46, 34, 10, 32, 32, 32, 32, 125, 10, 93, 10, 32, 32, 32, 32];
    let result_client_request = ClientRequest::from_vec(msg);
    assert!(true);
    Ok(())
}
