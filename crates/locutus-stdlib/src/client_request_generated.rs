...
pub mod client_request {
    ...
    impl<'a> WasmDelegateV1<'a> {
        ...
        pub fn key(&self) -> DelegateKey<'a> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<DelegateKey>>(WasmDelegateV1::VT_KEY, None)
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> ApplicationMessageBuilder<'a, 'b> {
        ...
        pub fn add_app(
            &mut self,
            app: flatbuffers::WIPOffset<super::common::ContractInstanceId<'b>>,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<super::common::ContractInstanceId>>(
                    ApplicationMessage::VT_APP,
    ...
    impl<'a: 'b, 'b> GetSecretResponseBuilder<'a, 'b> {
        ...
        pub fn add_value(&mut self, value: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(GetSecretResponse::VT_VALUE, value);
        }
        #[inline]
        pub fn add_context(
            &mut self,
        ...
        pub fn finish(self) -> flatbuffers::WIPOffset<GetSecretResponse<'a>> {
            ...
            self.fbb_
                .required(o, GetSecretResponse::VT_CONTEXT, "context");
            flatbuffers::WIPOffset::new(o.value())
        }
    }
    ...
    impl<'a> ApplicationMessages<'a> {
        ...
        pub fn inbound(
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<
                        flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<InboundDelegateMsg>>,
    ...
    impl<'a> GetSecretRequest<'a> {
        ...
        pub fn delegate_context(&self) -> flatbuffers::Vector<'a, u8> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        GetSecretRequest::VT_DELEGATE_CONTEXT,
                        None,
                    )
                    .unwrap()
            }
        ...
        pub fn processed(&self) -> bool {
            ...
            unsafe {
                self._tab
                    .get::<bool>(GetSecretRequest::VT_PROCESSED, Some(false))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> GetSecretRequestBuilder<'a, 'b> {
        ...
        pub fn add_processed(&mut self, processed: bool) {
            self.fbb_
                .push_slot::<bool>(GetSecretRequest::VT_PROCESSED, processed, false);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
        ) -> GetSecretRequestBuilder<'a, 'b> {
            let start = _fbb.start_table();
        ...
        pub fn finish(self) -> flatbuffers::WIPOffset<GetSecretRequest<'a>> {
            ...
            self.fbb_
                .required(o, GetSecretRequest::VT_DELEGATE_CONTEXT, "delegate_context");
            flatbuffers::WIPOffset::new(o.value())
        }
    }
    ...
    impl<'a> GetSecretRequestType<'a> {
        ...
        pub fn get_request(&self) -> GetSecretRequest<'a> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<GetSecretRequest>>(
    ...
    impl flatbuffers::Verifiable for GetSecretRequestType<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<GetSecretRequest>>(
                    "get_request",
                    Self::VT_GET_REQUEST,
                    true,
                )?
    ...
    impl<'a: 'b, 'b> GetSecretRequestTypeBuilder<'a, 'b> {
        ...
        pub fn add_get_request(
            &mut self,
            get_request: flatbuffers::WIPOffset<GetSecretRequest<'b>>,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<GetSecretRequest>>(
                    GetSecretRequestType::VT_GET_REQUEST,
                    get_request,
                );
        }
    ...
    impl<'a: 'b, 'b> RegisterDelegateBuilder<'a, 'b> {
        ...
        pub fn add_cipher(&mut self, cipher: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(RegisterDelegate::VT_CIPHER, cipher);
        }
        #[inline]
    ...
    impl<'a> GenerateRandData<'a> {
        ...
        pub fn data(&self) -> i32 {
            ...
            unsafe {
                self._tab
                    .get::<i32>(GenerateRandData::VT_DATA, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b> GenerateRandDataBuilder<'a, 'b> {
        ...
        pub fn add_data(&mut self, data: i32) {
            self.fbb_
                .push_slot::<i32>(GenerateRandData::VT_DATA, data, 0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    ...
    impl flatbuffers::Verifiable for ClientRequest<'_> {
        ...
        fn run_verifier(
            ...
            use self::flatbuffers::Verifiable;
            v.visit_table(pos)?
                .visit_union::<ClientRequestType, _>(
                    "client_request_type",
                    Self::VT_CLIENT_REQUEST_TYPE,
                    "client_request",
                    Self::VT_CLIENT_REQUEST,
                    true,
                    |key, v, pos| match key {
                        ClientRequestType::ContractRequest => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<ContractRequest>>(
                                "ClientRequestType::ContractRequest",
                                pos,
                            ),
                        ClientRequestType::DelegateRequest => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<DelegateRequest>>(
                                "ClientRequestType::DelegateRequest",
                                pos,
                            ),
                        ClientRequestType::GenerateRandData => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<GenerateRandData>>(
                                "ClientRequestType::GenerateRandData",
                                pos,
                            ),
                        ClientRequestType::Disconnect => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Disconnect>>(
                                "ClientRequestType::Disconnect",
                                pos,
                            ),
                        _ => Ok(()),
