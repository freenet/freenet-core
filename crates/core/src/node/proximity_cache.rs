...
pub struct ProximityCacheManager {
    ...
    #[allow(dead_code)] // Reserved for future batched announcement scheduling
...
struct NeighborCache {
    ...
    #[allow(dead_code)] // Reserved for future stale neighbor cleanup
    last_update: Instant,
}
...
impl ProximityCacheManager {
    ...
    #[allow(dead_code)] // Reserved for future peer synchronization
