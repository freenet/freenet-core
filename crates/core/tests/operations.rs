...
// NOTE: Removed test_subscription_tree_pruning, test_multiple_clients_prevent_premature_pruning,
// and test_subscription_pruning_sends_unsubscribed - these tested the old subscription tree model
// which was replaced with lease-based subscriptions in the 2026-01 refactor.
