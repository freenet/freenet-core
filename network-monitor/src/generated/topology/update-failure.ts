...
export class UpdateFailure {
  ...
  static createUpdateFailure(builder: flatbuffers.Builder, transactionOffset: flatbuffers.Offset, requesterOffset: flatbuffers.Offset, targetOffset: flatbuffers.Offset, keyOffset: flatbuffers.Offset, timestamp: bigint, contractLocation: number): flatbuffers.Offset {
    ...
    UpdateFailure.addTimestamp(builder, timestamp);
    UpdateFailure.addContractLocation(builder, contractLocation);
