...
static createUpdateRequest(builder:flatbuffers.Builder, transactionOffset:flatbuffers.Offset, keyOffset:flatbuffers.Offset, requesterOffset:flatbuffers.Offset, targetOffset:flatbuffers.Offset, timestamp:bigint, contractLocation:number):flatbuffers.Offset {
  UpdateRequest.startUpdateRequest(builder);
  UpdateRequest.addTransaction(builder, transactionOffset);
  UpdateRequest.addKey(builder, keyOffset);
  UpdateRequest.addRequester(builder, requesterOffset);
  UpdateRequest.addTarget(builder, targetOffset);
  UpdateRequest.addTimestamp(builder, timestamp);
  UpdateRequest.addContractLocation(builder, contractLocation);
