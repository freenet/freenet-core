...
pub mod common {
    ...
    impl<'a> GetSecretRequest<'a> {
        ...
        pub fn key(&self) -> SecretsId<'a> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<SecretsId>>(GetSecretRequest::VT_KEY, None)
                    .unwrap()
            }
        }
        #[inline]
    ...
    pub struct GetSecretRequestBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
        fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
    }
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetSecretRequestBuilder<'a, 'b, A> {
        #[inline]
        pub fn add_key(&mut self, key: flatbuffers::WIPOffset<SecretsId<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<SecretsId>>(
    ...
    impl<'a> GetSecretResponse<'a> {
        ...
        pub fn key(&self) -> SecretsId<'a> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<SecretsId>>(GetSecretResponse::VT_KEY, None)
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn delegate_context(&self) -> flatbuffers::Vector<'a, u8> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        GetSecretResponse::VT_DELEGATE_CONTEXT,
                        None,
                    )
                    .unwrap()
            }
    ...
    pub struct GetSecretResponseBuilder<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> {
        fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
    }
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GetSecretResponseBuilder<'a, 'b, A> {
        #[inline]
        pub fn add_key(&mut self, key: flatbuffers::WIPOffset<SecretsId<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<SecretsId>>(
        ...
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> GetSecretResponseBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    impl<'a> WasmContractV1<'a> {
        ...
        pub fn key(&self) -> ContractKey<'a> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<ContractKey>>(WasmContractV1::VT_KEY, None)
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RelatedStateUpdateBuilder<'a, 'b, A> {
        ...
        pub fn add_state(&mut self, state: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(RelatedStateUpdate::VT_STATE, state);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RelatedDeltaUpdateBuilder<'a, 'b, A> {
        ...
        pub fn add_delta(&mut self, delta: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(RelatedDeltaUpdate::VT_DELTA, delta);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
