...
fn main() {
    const RSA_4096_ID_1_PRIV_PEM: &str =
        include_str!("../../../../web/examples/rsa4096-id-0-priv.pem");
    const RSA_4096_ID_2_PRIV_PEM: &str =
        include_str!("../../../../web/examples/rsa4096-id-1-priv.pem");
