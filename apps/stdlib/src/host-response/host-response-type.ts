...
export function unionToHostResponseType(
  ...
  accessor: (obj:ContractResponse|DelegateResponse|GenerateRandData|Ok) => ContractResponse|DelegateResponse|GenerateRandData|Ok|null
): ContractResponse|DelegateResponse|GenerateRandData|Ok|null {
...
export function unionListToHostResponseType(
  type: HostResponseType, 
  accessor: (index: number, obj:ContractResponse|DelegateResponse|GenerateRandData|Ok) => ContractResponse|DelegateResponse|GenerateRandData|Ok|null, 
  index: number
): ContractResponse|DelegateResponse|GenerateRandData|Ok|null {
  switch(HostResponseType[type]) {
    case 'NONE': return null; 
