...
static createGetSecretResponse(builder:flatbuffers.Builder, keyOffset:flatbuffers.Offset, valueOffset:flatbuffers.Offset, contextOffset:flatbuffers.Offset):flatbuffers.Offset {
  ...
  GetSecretResponse.addContext(builder, contextOffset);
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const context = GetSecretResponse.createContextVector(builder, this.context);
