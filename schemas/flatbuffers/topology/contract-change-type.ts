...
import { BroadcastEmitted } from '../topology/broadcast-emitted.js';
import { BroadcastReceived } from '../topology/broadcast-received.js';
import { GetContract } from '../topology/get-contract.js';
...
export function unionToContractChangeType(
  ...
  switch(ContractChangeType[type]) {
    ...
    case 'BroadcastEmitted': return accessor(new BroadcastEmitted())! as BroadcastEmitted;
    case 'BroadcastReceived': return accessor(new BroadcastReceived())! as BroadcastReceived;
...
export function unionListToContractChangeType(
  ...
  switch(ContractChangeType[type]) {
    ...
    case 'BroadcastEmitted': return accessor(index, new BroadcastEmitted())! as BroadcastEmitted;
    case 'BroadcastReceived': return accessor(index, new BroadcastReceived())! as BroadcastReceived;
